...
#define LWM2M_SERVER_ADDR   "YOUR.SERVER.IP.HERE"
#define LWM2M_SERVER_PORT   YOUR_SERVER_LWM2M_PORT_HERE
#define CLIENT_DEVICE_NAME  "YOUR_CLIENT_DEVICE_NAME_HERE"
...
int main() 
{
    ...
    lwm2mH = lwm2m_init(CLIENT_DEVICE_NAME, 1, objArray, prv_buffer_send, NULL);
    if (NULL == lwm2mH)
    {
    ...
    Endpoint server;
    server.set_address(LWM2M_SERVER_ADDR,LWM2M_SERVER_PORT);
