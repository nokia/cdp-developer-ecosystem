package com.nokia.cdp.demo.getJobDetails;
...
public class GetJobDetails {
	public static void main(String[] args) {
		...
		System.out.println("Please provide the numeric Job ID: ");
		...
		HttpGet getJobHistory = new HttpGet("http://" + ipAddr + ":" + port + "/rest/device/" + id + "/job/" + jobId);
